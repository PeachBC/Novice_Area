...
var CHANNEL_ACCESS_TOKEN = "V9HeRF7Ov7B2/Rpkvy3divGBDq1xAsN0ff7iaIvbWtg+zJezUmsGC1msld09T34b631elijkjjZWd/kU/gpA18bDPAZ/UJZI6e56B7naZPj3ntkcjyIUcDIKdyh6UVjEI9xsYlP9fn55OF3GPrwRxAdB04t89/1O/w1cDnyilFU=";
var spreadSheetID = "1MAnD1vLAr6uRryfNS3rqPRJv89bX7zailEBqh9DCCqI";
var myID = "";
...
//設定分頁 GroupList
var sheet_GroupList = SpreadsheetApp.openById(spreadSheetID).getSheetByName("GroupList");
...
function doPost(e) {
  ...
  try {
    ...
    if (clientMessage.toLowerCase() == disableWord.toLowerCase()) {
      disableAutoPost(groupID, spreadSheetID);
      return;
    }
...
//把「是否提醒」數值調成0
function disableAutoPost(groupID, spreadSheetID) {
